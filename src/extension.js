...
var AutoMarkdownToc_1 = require("./AutoMarkdownToc");
function activate(context) {
    ...
    var deleteMarkdownToc = vscode_1.commands.registerCommand('extension.deleteMarkdownToc', function () { autoMarkdownToc.deleteMarkdownToc(); });
    var updateMarkdownSections = vscode_1.commands.registerCommand('extension.updateMarkdownSections', function () { autoMarkdownToc.updateMarkdownSections(); });
